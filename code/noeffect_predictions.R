...
full_sys_y <- dust_system_simulate(full_sys, t)
  ...
  file1<-paste("/Users/stacymowry/Desktop/CH2_FEB26/noeffect_allout.csv",sep="")
  file2<-paste("/Users/stacymowry/Desktop/CH2_FEB26/noeffect_alloverlap.csv",sep="")
  file2<-paste("/Users/stacymowry/Desktop/CH2_FEB26/noeffect_gams.csv",sep="")
  
  out<-cbind(L_BLAN_2016_out,
             N_BLAN_2016_out,
             L_BLAN_2017_out,
             N_BLAN_2017_out,
             L_BLAN_2018_out,
  ...
  write.csv(out, "/Users/stacymowry/Desktop/CH2_FEB26/noeffect_all_mat.csv")
  write.csv(all_overlaps_new, "/Users/stacymowry/Desktop/CH2_FEB26/noeffect_all_overlap.csv")
  
  se_B_L_16 <- out[unique(BLAN_a_2016$DOY),'L_BLAN_2016_out'] * (BLAN_a_2016$area[seq(1, length(BLAN_a_2016$area), by = 2)] /max(BLAN_a_2016$area))
  se_B_L_17 <- out[unique(BLAN_a_2017$DOY),'L_BLAN_2017_out'] * (BLAN_a_2017$area[seq(1, length(BLAN_a_2017$area), by = 2)] /max(BLAN_a_2017$area))
  se_B_L_18 <- out[unique(BLAN_a_2018$DOY),'L_BLAN_2018_out'] * (BLAN_a_2018$area[seq(1, length(BLAN_a_2018$area), by = 2)] /max(BLAN_a_2018$area))
  se_B_L_19 <- out[unique(BLAN_a_2019$DOY),'L_BLAN_2019_out'] * (BLAN_a_2019$area[seq(1, length(BLAN_a_2019$area), by = 2)] /max(BLAN_a_2019$area))

  se_B_N_16 <- out[unique(BLAN_a_2016$DOY),'N_BLAN_2016_out'] * (BLAN_a_2016$area[seq(1, length(BLAN_a_2016$area), by = 2)] /max(BLAN_a_2016$area))
  se_B_N_17 <- out[unique(BLAN_a_2017$DOY),'N_BLAN_2017_out'] * (BLAN_a_2017$area[seq(1, length(BLAN_a_2017$area), by = 2)] /max(BLAN_a_2017$area))
  se_B_N_18 <- out[unique(BLAN_a_2018$DOY),'N_BLAN_2018_out'] * (BLAN_a_2018$area[seq(1, length(BLAN_a_2018$area), by = 2)] /max(BLAN_a_2018$area))
  se_B_N_19 <- out[unique(BLAN_a_2019$DOY),'N_BLAN_2019_out'] * (BLAN_a_2019$area[seq(1, length(BLAN_a_2019$area), by = 2)] /max(BLAN_a_2019$area))

  
  se_H_L_17 <- out[unique(HARV_a_2017$DOY),'L_HARV_2017_out'] * (HARV_a_2017$area[seq(1, length(HARV_a_2017$area), by = 2)] /max(HARV_a_2017$area))
  se_H_L_18 <- out[unique(HARV_a_2018$DOY),'L_HARV_2018_out'] * (HARV_a_2018$area[seq(1, length(HARV_a_2018$area), by = 2)] /max(HARV_a_2018$area))
  se_H_L_21 <- out[unique(HARV_a_2021$DOY),'L_HARV_2021_out'] * (HARV_a_2021$area[seq(1, length(HARV_a_2021$area), by = 2)] /max(HARV_a_2021$area))
  se_H_L_23 <- out[unique(HARV_a_2023$DOY),'L_HARV_2023_out'] * (HARV_a_2023$area[seq(1, length(HARV_a_2023$area), by = 2)] /max(HARV_a_2023$area))
  
 
  se_H_N_17 <- out[unique(HARV_a_2017$DOY),'N_HARV_2017_out'] * (HARV_a_2017$area[seq(1, length(HARV_a_2017$area), by = 2)] /max(HARV_a_2017$area))
  se_H_N_18 <- out[unique(HARV_a_2018$DOY),'N_HARV_2018_out'] * (HARV_a_2018$area[seq(1, length(HARV_a_2018$area), by = 2)] /max(HARV_a_2018$area))
  se_H_N_21 <- out[unique(HARV_a_2021$DOY),'N_HARV_2021_out'] * (HARV_a_2021$area[seq(1, length(HARV_a_2021$area), by = 2)] /max(HARV_a_2021$area))
  se_H_N_23 <- out[unique(HARV_a_2023$DOY),'N_HARV_2023_out'] * (HARV_a_2023$area[seq(1, length(HARV_a_2023$area), by = 2)] /max(HARV_a_2023$area))
  
  
  
  se_S_L_16 <- out[unique(SCBI_a_2016$DOY),'L_SCBI_2016_out'] * (SCBI_a_2016$area[seq(1, length(SCBI_a_2016$area), by = 2)] /max(SCBI_a_2016$area))
  se_S_L_17 <- out[unique(SCBI_a_2017$DOY),'L_SCBI_2017_out'] * (SCBI_a_2017$area[seq(1, length(SCBI_a_2017$area), by = 2)] /max(SCBI_a_2017$area))
  se_S_L_18 <- out[unique(SCBI_a_2018$DOY),'L_SCBI_2018_out'] * (SCBI_a_2018$area[seq(1, length(SCBI_a_2018$area), by = 2)] /max(SCBI_a_2018$area))
  se_S_L_19 <- out[unique(SCBI_a_2019$DOY),'L_SCBI_2019_out'] * (SCBI_a_2019$area[seq(1, length(SCBI_a_2019$area), by = 2)] /max(SCBI_a_2019$area))
  se_S_L_23 <- out[unique(SCBI_a_2023$DOY),'L_SCBI_2023_out'] * (SCBI_a_2023$area[seq(1, length(SCBI_a_2023$area), by = 2)] /max(SCBI_a_2023$area))
  
  se_S_N_16 <- out[unique(SCBI_a_2016$DOY),'N_SCBI_2016_out'] * (SCBI_a_2016$area[seq(1, length(SCBI_a_2016$area), by = 2)] /max(SCBI_a_2016$area))
  se_S_N_17 <- out[unique(SCBI_a_2017$DOY),'N_SCBI_2017_out'] * (SCBI_a_2017$area[seq(1, length(SCBI_a_2017$area), by = 2)] /max(SCBI_a_2017$area))
  se_S_N_18 <- out[unique(SCBI_a_2018$DOY),'N_SCBI_2018_out'] * (SCBI_a_2018$area[seq(1, length(SCBI_a_2018$area), by = 2)] /max(SCBI_a_2018$area))
  se_S_N_19 <- out[unique(SCBI_a_2019$DOY),'N_SCBI_2019_out'] * (SCBI_a_2019$area[seq(1, length(SCBI_a_2019$area), by = 2)] /max(SCBI_a_2019$area))
  se_S_N_23 <- out[unique(SCBI_a_2023$DOY),'N_SCBI_2023_out'] * (SCBI_a_2023$area[seq(1, length(SCBI_a_2023$area), by = 2)] /max(SCBI_a_2023$area))
  ...
  BLAN_16L_data_from_NE<-matrix(0,nrow=nrow(BLAN_a_2016), ncol = 100)
  BLAN_16N_data_from_NE<-matrix(0,nrow=nrow(BLAN_a_2016), ncol = 100)
  BLAN_17L_data_from_NE<-matrix(0,nrow=nrow(BLAN_a_2017), ncol = 100)
  BLAN_17N_data_from_NE<-matrix(0,nrow=nrow(BLAN_a_2017), ncol = 100)
  BLAN_18L_data_from_NE<-matrix(0,nrow=nrow(BLAN_a_2018), ncol = 100)
  BLAN_18N_data_from_NE<-matrix(0,nrow=nrow(BLAN_a_2018), ncol = 100)
  BLAN_19L_data_from_NE<-matrix(0,nrow=nrow(BLAN_a_2019), ncol = 100)
  BLAN_19N_data_from_NE<-matrix(0,nrow=nrow(BLAN_a_2019), ncol = 100)
 
  
  
  
  HARV_17L_data_from_NE<-matrix(0,nrow=nrow(HARV_a_2017), ncol = 100)
  HARV_17N_data_from_NE<-matrix(0,nrow=nrow(HARV_a_2017), ncol = 100)
  HARV_18L_data_from_NE<-matrix(0,nrow=nrow(HARV_a_2018), ncol = 100)
  HARV_18N_data_from_NE<-matrix(0,nrow=nrow(HARV_a_2018), ncol = 100)
 
  HARV_21L_data_from_NE<-matrix(0,nrow=nrow(HARV_a_2021), ncol = 100)
  HARV_21N_data_from_NE<-matrix(0,nrow=nrow(HARV_a_2021), ncol = 100)
 
  HARV_23L_data_from_NE<-matrix(0,nrow=nrow(HARV_a_2023), ncol = 100)
  HARV_23N_data_from_NE<-matrix(0,nrow=nrow(HARV_a_2023), ncol = 100)
  
  
  SCBI_16L_data_from_NE<-matrix(0,nrow=nrow(SCBI_a_2016), ncol = 100)
  SCBI_16N_data_from_NE<-matrix(0,nrow=nrow(SCBI_a_2016), ncol = 100)
  SCBI_17L_data_from_NE<-matrix(0,nrow=nrow(SCBI_a_2017), ncol = 100)
  SCBI_17N_data_from_NE<-matrix(0,nrow=nrow(SCBI_a_2017), ncol = 100)
  SCBI_18L_data_from_NE<-matrix(0,nrow=nrow(SCBI_a_2018), ncol = 100)
  SCBI_18N_data_from_NE<-matrix(0,nrow=nrow(SCBI_a_2018), ncol = 100)
  SCBI_19L_data_from_NE<-matrix(0,nrow=nrow(SCBI_a_2019), ncol = 100)
  SCBI_19N_data_from_NE<-matrix(0,nrow=nrow(SCBI_a_2019), ncol = 100)
 
  SCBI_23L_data_from_NE<-matrix(0,nrow=nrow(SCBI_a_2023), ncol = 100)
  SCBI_23N_data_from_NE<-matrix(0,nrow=nrow(SCBI_a_2023), ncol = 100)
  ...
  BLAN_16L_data_from_NE[,pred_idx]<-save_sort_current_B_L_2016
  BLAN_17L_data_from_NE[,pred_idx]<-save_sort_current_B_L_2017
  BLAN_18L_data_from_NE[,pred_idx]<-save_sort_current_B_L_2018
  BLAN_19L_data_from_NE[,pred_idx]<-save_sort_current_B_L_2019

  BLAN_16N_data_from_NE[,pred_idx]<-save_sort_current_B_N_2016
  BLAN_17N_data_from_NE[,pred_idx]<-save_sort_current_B_N_2017
  BLAN_18N_data_from_NE[,pred_idx]<-save_sort_current_B_N_2018
  BLAN_19N_data_from_NE[,pred_idx]<-save_sort_current_B_N_2019
 
  
  HARV_17L_data_from_NE[,pred_idx]<-save_sort_current_H_L_2017
  HARV_18L_data_from_NE[,pred_idx]<-save_sort_current_H_L_2018
  HARV_21L_data_from_NE[,pred_idx]<-save_sort_current_H_L_2021
  HARV_23L_data_from_NE[,pred_idx]<-save_sort_current_H_L_2023
  
  
 
  HARV_17N_data_from_NE[,pred_idx]<-save_sort_current_H_N_2017
  HARV_18N_data_from_NE[,pred_idx]<-save_sort_current_H_N_2018
  HARV_21N_data_from_NE[,pred_idx]<-save_sort_current_H_N_2021
  HARV_23N_data_from_NE[,pred_idx]<-save_sort_current_H_N_2023
  
  
  SCBI_16L_data_from_NE[,pred_idx]<-save_sort_current_S_L_2016
  SCBI_17L_data_from_NE[,pred_idx]<-save_sort_current_S_L_2017
  SCBI_18L_data_from_NE[,pred_idx]<-save_sort_current_S_L_2018
  SCBI_19L_data_from_NE[,pred_idx]<-save_sort_current_S_L_2019
  SCBI_23L_data_from_NE[,pred_idx]<-save_sort_current_S_L_2023
  
  
  SCBI_16N_data_from_NE[,pred_idx]<-save_sort_current_S_N_2016
  SCBI_17N_data_from_NE[,pred_idx]<-save_sort_current_S_N_2017
  SCBI_18N_data_from_NE[,pred_idx]<-save_sort_current_S_N_2018
  SCBI_19N_data_from_NE[,pred_idx]<-save_sort_current_S_N_2019
  SCBI_23N_data_from_NE[,pred_idx]<-save_sort_current_S_N_2023
...
##write out estimates
write.csv(BLAN_16L_data_from_NE,"~/Desktop/CH2_FEB26/annual_NE_preds_BLAN_L_16.csv")
write.csv(BLAN_17L_data_from_NE,"~/Desktop/CH2_FEB26/annual_NE_preds_BLAN_L_17.csv")
write.csv(BLAN_18L_data_from_NE,"~/Desktop/CH2_FEB26/annual_NE_preds_BLAN_L_18.csv")
write.csv(BLAN_19L_data_from_NE,"~/Desktop/CH2_FEB26/annual_NE_preds_BLAN_L_19.csv")

write.csv(BLAN_16N_data_from_NE,"~/Desktop/CH2_FEB26/annual_NE_preds_BLAN_N_16.csv")
write.csv(BLAN_17N_data_from_NE,"~/Desktop/CH2_FEB26/annual_NE_preds_BLAN_N_17.csv")
write.csv(BLAN_18N_data_from_NE,"~/Desktop/CH2_FEB26/annual_NE_preds_BLAN_N_18.csv")
write.csv(BLAN_19N_data_from_NE,"~/Desktop/CH2_FEB26/annual_NE_preds_BLAN_N_19.csv")


write.csv(HARV_17L_data_from_NE,"~/Desktop/CH2_FEB26/annual_NE_preds_HARV_L_17.csv")
write.csv(HARV_18L_data_from_NE,"~/Desktop/CH2_FEB26/annual_NE_preds_HARV_L_18.csv")
write.csv(HARV_21L_data_from_NE,"~/Desktop/CH2_FEB26/annual_NE_preds_HARV_L_21.csv")
write.csv(HARV_23L_data_from_NE,"~/Desktop/CH2_FEB26/annual_NE_preds_HARV_L_23.csv")



write.csv(HARV_17N_data_from_NE,"~/Desktop/CH2_FEB26/annual_NE_preds_HARV_N_17.csv")
write.csv(HARV_18N_data_from_NE,"~/Desktop/CH2_FEB26/annual_NE_preds_HARV_N_18.csv")
write.csv(HARV_21N_data_from_NE,"~/Desktop/CH2_FEB26/annual_NE_preds_HARV_N_21.csv")
write.csv(HARV_23N_data_from_NE,"~/Desktop/CH2_FEB26/annual_NE_preds_HARV_N_23.csv")

write.csv(SCBI_16L_data_from_NE,"~/Desktop/CH2_FEB26/annual_NE_preds_SCBI_L_16.csv")
write.csv(SCBI_17L_data_from_NE,"~/Desktop/CH2_FEB26/annual_NE_preds_SCBI_L_17.csv")
write.csv(SCBI_18L_data_from_NE,"~/Desktop/CH2_FEB26/annual_NE_preds_SCBI_L_18.csv")
write.csv(SCBI_19L_data_from_NE,"~/Desktop/CH2_FEB26/annual_NE_preds_SCBI_L_19.csv")
write.csv(SCBI_23L_data_from_NE,"~/Desktop/CH2_FEB26/annual_NE_preds_SCBI_L_23.csv")



write.csv(SCBI_16N_data_from_NE,"~/Desktop/CH2_FEB26/annual_NE_preds_SCBI_N_16.csv")
write.csv(SCBI_17N_data_from_NE,"~/Desktop/CH2_FEB26/annual_NE_preds_SCBI_N_17.csv")
write.csv(SCBI_18N_data_from_NE,"~/Desktop/CH2_FEB26/annual_NE_preds_SCBI_N_18.csv")
write.csv(SCBI_19N_data_from_NE,"~/Desktop/CH2_FEB26/annual_NE_preds_SCBI_N_19.csv")
write.csv(SCBI_23N_data_from_NE,"~/Desktop/CH2_FEB26/annual_NE_preds_SCBI_N_23.csv")
