##script to generate model predictions with uncertainty 
...
dln_bar<-rnorm(n_prior_samples,m_log_dln_bar,s_log_dln_bar)
dln_sigma<-rexp(n_prior_samples,rate_log_dln_sigma)

a_n_bar<-rnorm(n_prior_samples,m_a_n_bar,s_a_n_bar)
a_n_sigma<-rexp(n_prior_samples,rate_a_n_sigma)

a_l_bar<-rnorm(n_prior_samples,m_log_al_bar, s_log_al_bar)
a_l_sigma<-rexp(n_prior_samples,rate_log_al_sigma)

a_a_bar<-rnorm(n_prior_samples,m_log_aa_bar,s_log_aa_bar)
a_a_sigma<-rexp(n_prior_samples,rate_log_al_sigma)


##sample from priors

log_dln_points_BLAN<-rnorm(n_prior_samples,dln_bar,dln_sigma)
log_dln_points_HARV<-rnorm(n_prior_samples,dln_bar,dln_sigma)
log_dln_points_SCBI<-rnorm(n_prior_samples,dln_bar,dln_sigma)

an_points_BLAN<-rnorm(n_prior_samples,a_n_bar,a_n_sigma)
an_points_HARV<-rnorm(n_prior_samples,a_n_bar,a_n_sigma)
an_points_SCBI<-rnorm(n_prior_samples,a_n_bar,a_n_sigma)

log_al_points_BLAN<-rnorm(n_prior_samples,a_l_bar,a_l_sigma)
log_al_points_HARV<-rnorm(n_prior_samples,a_l_bar,a_l_sigma)
log_al_points_SCBI<-rnorm(n_prior_samples,a_l_bar,a_l_sigma)

log_aa_points_BLAN<-rnorm(n_prior_samples,a_a_bar,a_a_sigma)
log_aa_points_HARV<-rnorm(n_prior_samples,a_a_bar, a_a_sigma)
log_aa_points_SCBI<-rnorm(n_prior_samples,a_a_bar,a_a_sigma)
...
##put prior samples together into a df
prior_pars <- data.frame(
  log_dln_BLAN = log_dln_points_BLAN,
  log_dln_HARV = log_dln_points_HARV,
  log_dln_SCBI = log_dln_points_SCBI,
  
  a_n_BLAN = an_points_BLAN,
  a_n_HARV = an_points_HARV,
  a_n_SCBI = an_points_SCBI,
  
  log_al_BLAN = log_al_points_BLAN,
  log_al_HARV = log_al_points_HARV,
  log_al_SCBI = log_al_points_SCBI,
  
  log_aa_BLAN = log_aa_points_BLAN,
  log_aa_HARV = log_aa_points_HARV,
  log_aa_SCBI = log_aa_points_SCBI)
...
##plot humidity functions
# plot(time<-c(1:365),SCBI_humid_int_2018  +  SCBI_humid_amp_2018 *sin((2*pi/365)*(time-SCBI_phaseshift_2018)), type="l",ylim=c(60,100))
# lines(time<-c(1:365),SCBI_humid_int_2017  +  SCBI_humid_amp_2017 *sin((2*pi/365)*(time-SCBI_phaseshift_2017)), lty=2)
# lines(time<-c(1:365),SCBI_humid_int_2016  +  SCBI_humid_amp_2016 *sin((2*pi/365)*(time-SCBI_phaseshift_2016)), lty=3)
# 
#lines(time<-c(1:365),HARV_humid_int_2018  +  HARV_humid_amp_2018 *sin((2*pi/365)*(time-HARV_phaseshift_2018)), type="l",col="black")
#lines(time<-c(1:365),HARV_humid_int_2017  +  HARV_humid_amp_2017 *sin((2*pi/365)*(time-HARV_phaseshift_2017)), lty=2,col="black")
#lines(time<-c(1:365),HARV_humid_int_2016  +  HARV_humid_amp_2016 *sin((2*pi/365)*(time-HARV_phaseshift_2016)), lty=3,col="black")
# 
# plot(time<-c(1:365),BLAN_humid_int_2018  +  BLAN_humid_amp_2018 *sin((2*pi/365)*(time-BLAN_phaseshift_2018)), type="l",col="blue")
# lines(time<-c(1:365),BLAN_humid_int_2017  +  BLAN_humid_amp_2017 *sin((2*pi/365)*(time-BLAN_phaseshift_2017)), lty=2,col="blue")
# lines(time<-c(1:365),BLAN_humid_int_2016  +  BLAN_humid_amp_2016 *sin((2*pi/365)*(time-BLAN_phaseshift_2016)), lty=3,col="blue")
# 
# abline(h=80,col="blue",lwd=2)
# abline(h=72,col="blue",lwd=2)
# 
# abline(v=155,col="blue",lty=3)
# abline(v=165,col="blue",lty=2)
# abline(v=155,col="blue",lty=1)
# 
# abline(h=77,col="red",lwd=2)
# abline(h=86,col="red",lwd=2)
# 
# abline(v=250,col="red",lty=3)
# abline(v=220,col="red",lty=2)
# abline(v=180,col="red",lty=1)
# 
# abline(h=77,col="black",lwd=2)
# abline(h=70,col="black",lwd=2)
# 
# abline(v=180,col="black",lty=3)
# abline(v=170,col="black",lty=2)
# abline(v=180,col="black",lty=1)
...
B_L_16_file<-paste("~/Desktop/CH2_FEB26/prioreffect_unc_B_L16_preds_nosamplewindow.csv",sep="")
B_L_17_file<-paste("~/Desktop/CH2_FEB26/prioreffect_unc_B_L17_preds_nosamplewindow.csv",sep="")
B_L_18_file<-paste("~/Desktop/CH2_FEB26/prioreffect_unc_B_L18_preds_nosamplewindow.csv",sep="")
B_L_19_file<-paste("~/Desktop/CH2_FEB26/prioreffect_unc_B_L19_preds_nosamplewindow.csv",sep="")


B_N_16_file<-paste("~/Desktop/CH2_FEB26/prioreffect_unc_B_N16_preds_nosamplewindow.csv",sep="")
B_N_17_file<-paste("~/Desktop/CH2_FEB26/prioreffect_unc_B_N17_preds_nosamplewindow.csv",sep="")
B_N_18_file<-paste("~/Desktop/CH2_FEB26/prioreffect_unc_B_N18_preds_nosamplewindow.csv",sep="")
B_N_19_file<-paste("~/Desktop/CH2_FEB26/prioreffect_unc_B_N19_preds_nosamplewindow.csv",sep="")



H_L_17_file<-paste("~/Desktop/CH2_FEB26/prioreffect_unc_H_L17_preds_nosamplewindow.csv",sep="")
H_L_18_file<-paste("~/Desktop/CH2_FEB26/prioreffect_unc_H_L18_preds_nosamplewindow.csv",sep="")
H_L_21_file<-paste("~/Desktop/CH2_FEB26/prioreffect_unc_H_L21_preds_nosamplewindow.csv",sep="")
H_L_23_file<-paste("~/Desktop/CH2_FEB26/prioreffect_unc_H_L23_preds_nosamplewindow.csv",sep="")



H_N_17_file<-paste("~/Desktop/CH2_FEB26/prioreffect_unc_H_N17_preds_nosamplewindow.csv",sep="")
H_N_18_file<-paste("~/Desktop/CH2_FEB26/prioreffect_unc_H_N18_preds_nosamplewindow.csv",sep="")
H_N_21_file<-paste("~/Desktop/CH2_FEB26/prioreffect_unc_H_N21_preds_nosamplewindow.csv",sep="")
H_N_23_file<-paste("~/Desktop/CH2_FEB26/prioreffect_unc_H_N23_preds_nosamplewindow.csv",sep="")


S_L_16_file<-paste("~/Desktop/CH2_FEB26/prioreffect_unc_S_L16_preds_nosamplewindow.csv",sep="")
S_L_17_file<-paste("~/Desktop/CH2_FEB26/prioreffect_unc_S_L17_preds_nosamplewindow.csv",sep="")
S_L_18_file<-paste("~/Desktop/CH2_FEB26/prioreffect_unc_S_L18_preds_nosamplewindow.csv",sep="")
S_L_19_file<-paste("~/Desktop/CH2_FEB26/prioreffect_unc_S_L19_preds_nosamplewindow.csv",sep="")
S_L_23_file<-paste("~/Desktop/CH2_FEB26/prioreffect_unc_S_L23_preds_nosamplewindow.csv",sep="")


S_N_16_file<-paste("~/Desktop/CH2_FEB26/prioreffect_unc_S_N16_preds_nosamplewindow.csv",sep="")
S_N_17_file<-paste("~/Desktop/CH2_FEB26/prioreffect_unc_S_N17_preds_nosamplewindow.csv",sep="")
S_N_18_file<-paste("~/Desktop/CH2_FEB26/prioreffect_unc_S_N18_preds_nosamplewindow.csv",sep="")
S_N_19_file<-paste("~/Desktop/CH2_FEB26/prioreffect_unc_S_N19_preds_nosamplewindow.csv",sep="")
S_N_23_file<-paste("~/Desktop/CH2_FEB26/prioreffect_unc_S_N23_preds_nosamplewindow.csv",sep="")


all_overlaps_file<-paste("~/Desktop/CH2_FEB26/prioreffect_unc_overlap_nosamplewindow.csv",sep="")

B_L_16_mat<-matrix(0, nrow=365,ncol=n_prior_samples)
B_L_17_mat<-matrix(0, nrow=365,ncol=n_prior_samples)
B_L_18_mat<-matrix(0, nrow=365,ncol=n_prior_samples)
B_L_19_mat<-matrix(0, nrow=365,ncol=n_prior_samples)

B_N_16_mat<-matrix(0, nrow=365,ncol=n_prior_samples)
B_N_17_mat<-matrix(0, nrow=365,ncol=n_prior_samples)
B_N_18_mat<-matrix(0, nrow=365,ncol=n_prior_samples)
B_N_19_mat<-matrix(0, nrow=365,ncol=n_prior_samples)



H_L_17_mat<-matrix(0, nrow=365,ncol=n_prior_samples)
H_L_18_mat<-matrix(0, nrow=365,ncol=n_prior_samples)
H_L_21_mat<-matrix(0, nrow=365,ncol=n_prior_samples)
H_L_23_mat<-matrix(0, nrow=365,ncol=n_prior_samples)




H_N_17_mat<-matrix(0, nrow=365,ncol=n_prior_samples)
H_N_18_mat<-matrix(0, nrow=365,ncol=n_prior_samples)
H_N_21_mat<-matrix(0, nrow=365,ncol=n_prior_samples)
H_N_23_mat<-matrix(0, nrow=365,ncol=n_prior_samples)


S_L_16_mat<-matrix(0, nrow=365,ncol=n_prior_samples)
S_L_17_mat<-matrix(0, nrow=365,ncol=n_prior_samples)
S_L_18_mat<-matrix(0, nrow=365,ncol=n_prior_samples)
S_L_19_mat<-matrix(0, nrow=365,ncol=n_prior_samples)
S_L_23_mat<-matrix(0, nrow=365,ncol=n_prior_samples)



S_N_16_mat<-matrix(0, nrow=365,ncol=n_prior_samples)
S_N_17_mat<-matrix(0, nrow=365,ncol=n_prior_samples)
S_N_18_mat<-matrix(0, nrow=365,ncol=n_prior_samples)
S_N_19_mat<-matrix(0, nrow=365,ncol=n_prior_samples)
S_N_23_mat<-matrix(0, nrow=365,ncol=n_prior_samples)


all_overlaps<-matrix(0, nrow=13,ncol=n_prior_samples)


for (samp_idx in 107: 115)
{
  print(samp_idx)
  full_pars <- list( theta_i_norm = theta_i_norm,
                     ...
                     log_dln_BLAN = prior_pars[samp_idx,"log_dln_BLAN"],
                     log_dln_SCBI = prior_pars[samp_idx,"log_dln_SCBI"],
                     log_dln_HARV = prior_pars[samp_idx,"log_dln_HARV"],
                     log_aa_BLAN = prior_pars[samp_idx,"log_aa_BLAN"],
                     log_aa_HARV = prior_pars[samp_idx,"log_aa_HARV"],
                     log_aa_SCBI = prior_pars[samp_idx,"log_aa_SCBI"],
                     log_al_BLAN = prior_pars[samp_idx,"log_al_BLAN"],
                     log_al_HARV = prior_pars[samp_idx,"log_al_HARV"],
                     log_al_SCBI = prior_pars[samp_idx,"log_al_SCBI"],
                     
                     a_n_BLAN = prior_pars[samp_idx,"a_n_BLAN"],
                     a_n_HARV = prior_pars[samp_idx,"a_n_HARV"],
                     a_n_SCBI = prior_pars[samp_idx,"a_n_SCBI"]
                     
                     # log_dln_BLAN = median(prior_pars[,"log_dln_BLAN"]),
                     # log_dln_SCBI = median(prior_pars[,"log_dln_SCBI"]),
                     # log_dln_HARV = median(prior_pars[,"log_dln_HARV"]),
                     # log_aa_BLAN = median(prior_pars[,"log_aa_BLAN"]),
                     # log_aa_HARV = median(prior_pars[,"log_aa_HARV"]),
                     # log_aa_SCBI = median(prior_pars[,"log_aa_SCBI"]),
                     # log_al_BLAN = median(prior_pars[,"log_al_BLAN"]),
                     # log_al_HARV = median(prior_pars[,"log_al_HARV"]),
                     # log_al_SCBI = median(prior_pars[,"log_al_SCBI"]),
                     # 
                     # a_n_BLAN = median(prior_pars[,"a_n_BLAN"]),
                     # a_n_HARV = median(prior_pars[,"a_n_HARV"]),
                     # a_n_SCBI = median(prior_pars[,"a_n_SCBI"])
  ...
  B_L_16_mat<-cbind(B_L_16_mat,L_BLAN_2016_out)
  B_L_17_mat<-cbind( B_L_17_mat,L_BLAN_2017_out)
  B_L_18_mat<-cbind(B_L_18_mat,L_BLAN_2018_out)
  B_L_19_mat<-cbind(B_L_19_mat,L_BLAN_2019_out)
  
  
  B_N_16_mat<-cbind(B_N_16_mat,N_BLAN_2016_out)
  B_N_17_mat<-cbind(B_N_17_mat,N_BLAN_2017_out)
  B_N_18_mat<-cbind(B_N_18_mat,N_BLAN_2018_out)
  B_N_19_mat<-cbind(B_N_19_mat,N_BLAN_2019_out)
  
  
  H_L_17_mat<-cbind(H_L_17_mat,L_HARV_2017_out)
  H_L_18_mat<-cbind(H_L_18_mat,L_HARV_2018_out)
  
  H_L_21_mat<-cbind(H_L_21_mat,L_HARV_2021_out)
  
  H_L_23_mat<-cbind(H_L_23_mat,L_HARV_2023_out)
  
  
  H_N_17_mat<-cbind(H_N_17_mat,N_HARV_2017_out)
  H_N_18_mat<-cbind(H_N_18_mat,N_HARV_2018_out)
  
  H_N_21_mat<-cbind(H_N_21_mat,N_HARV_2021_out)
  
  H_N_23_mat<-cbind(H_N_23_mat,N_HARV_2023_out)
  
  S_L_16_mat<-cbind(S_L_16_mat,L_SCBI_2016_out)
  S_L_17_mat<-cbind(S_L_17_mat,L_SCBI_2017_out)
  S_L_18_mat<-cbind(S_L_18_mat,L_SCBI_2018_out)
  S_L_19_mat<-cbind(S_L_19_mat,L_SCBI_2019_out)
  
  S_L_23_mat<-cbind(S_L_23_mat,L_SCBI_2023_out)
  
  S_N_16_mat<-cbind(S_N_16_mat,N_SCBI_2016_out)
  S_N_17_mat<-cbind(S_N_17_mat,N_SCBI_2017_out)
  S_N_18_mat<-cbind(S_N_18_mat,N_SCBI_2018_out)
  S_N_19_mat<-cbind(S_N_19_mat,N_SCBI_2019_out)
  
  S_N_23_mat<-cbind(S_N_23_mat,N_SCBI_2023_out)
  
  all_overlaps<-cbind(all_overlaps,all_overlaps_new)
...
write.csv(all_overlaps[,1:100], paste0("~/Desktop/CH2_FEB26/all_overlaps_prior_unc_nosamplewindow.csv"))


write.csv(B_L_16_mat[,1:100], paste0("~/Desktop/CH2_FEB26/B_L_16_mat_prior_unc_nosamplewindow.csv"))
write.csv(B_L_17_mat[,1:100], paste0("~/Desktop/CH2_FEB26/B_L_17_mat_prior_unc_nosamplewindow.csv"))
write.csv(B_L_18_mat[,1:100], paste0("~/Desktop/CH2_FEB26/B_L_18_mat_prior_unc_nosamplewindow.csv"))
write.csv(B_L_19_mat[,1:100], paste0("~/Desktop/CH2_FEB26/B_L_19_mat_prior_unc_nosamplewindow.csv"))



write.csv(H_L_17_mat[,1:100], paste0("~/Desktop/CH2_FEB26/H_L_17_mat_prior_unc_nosamplewindow.csv"))
write.csv(H_L_18_mat[,1:100], paste0("~/Desktop/CH2_FEB26/H_L_18_mat_prior_unc_nosamplewindow.csv"))
write.csv(H_L_21_mat[,1:100], paste0("~/Desktop/CH2_FEB26/H_L_21_mat_prior_unc_nosamplewindow.csv"))
write.csv(H_L_23_mat[,1:100], paste0("~/Desktop/CH2_FEB26/H_L_23_mat_prior_unc_nosamplewindow.csv"))

write.csv(S_L_16_mat[,1:100], paste0("~/Desktop/CH2_FEB26/S_L_16_mat_prior_unc_nosamplewindow.csv"))
write.csv(S_L_17_mat[,1:100], paste0("~/Desktop/CH2_FEB26/S_L_17_mat_prior_unc_nosamplewindow.csv"))
write.csv(S_L_18_mat[,1:100], paste0("~/Desktop/CH2_FEB26/S_L_18_mat_prior_unc_nosamplewindow.csv"))
write.csv(S_L_19_mat[,1:100], paste0("~/Desktop/CH2_FEB26/S_L_19_mat_prior_unc_nosamplewindow.csv"))
write.csv(S_L_23_mat[,1:100], paste0("~/Desktop/CH2_FEB26/S_L_23_mat_prior_unc_nosamplewindow.csv"))


# 
# 
write.csv(B_N_16_mat[,1:100], paste0("~/Desktop/CH2_FEB26/B_N_16_mat_prior_unc_nosamplewindow.csv"))
write.csv(B_N_17_mat[,1:100], paste0("~/Desktop/CH2_FEB26/B_N_17_mat_prior_unc_nosamplewindow.csv"))
write.csv(B_N_18_mat[,1:100], paste0("~/Desktop/CH2_FEB26/B_N_18_mat_prior_unc_nosamplewindow.csv"))
write.csv(B_N_19_mat[,1:100], paste0("~/Desktop/CH2_FEB26/B_N_19_mat_prior_unc_nosamplewindow.csv"))



write.csv(H_N_17_mat[,1:100], paste0("~/Desktop/CH2_FEB26/H_N_17_mat_prior_unc_nosamplewindow.csv"))
write.csv(H_N_18_mat[,1:100], paste0("~/Desktop/CH2_FEB26/H_N_18_mat_prior_unc_nosamplewindow.csv"))
write.csv(H_N_21_mat[,1:100], paste0("~/Desktop/CH2_FEB26/H_N_21_mat_prior_unc_nosamplewindow.csv"))
write.csv(H_N_23_mat[,1:100], paste0("~/Desktop/CH2_FEB26/H_N_23_mat_prior_unc_nosamplewindow.csv"))



write.csv(S_N_16_mat[,1:100], paste0("~/Desktop/CH2_FEB26/S_N_16_mat_prior_unc_nosamplewindow.csv"))
write.csv(S_N_17_mat[,1:100], paste0("~/Desktop/CH2_FEB26/S_N_17_mat_prior_unc_nosamplewindow.csv"))
write.csv(S_N_18_mat[,1:100], paste0("~/Desktop/CH2_FEB26/S_N_18_mat_prior_unc_nosamplewindow.csv"))
write.csv(S_N_19_mat[,1:100], paste0("~/Desktop/CH2_FEB26/S_N_19_mat_prior_unc_nosamplewindow.csv"))
write.csv(S_N_23_mat[,1:100], paste0("~/Desktop/CH2_FEB26/S_N_23_mat_prior_unc_nosamplewindow.csv"))


# B_L_16_mat<-read.csv("~/Desktop/fitted161718_B_L_16_mat_unc.csv")
# B_L_17_mat<-read.csv("~/Desktop/fitted161718_B_L_17_mat_unc.csv")
# B_L_18_mat<-read.csv("~/Desktop/fitted161718_B_L_18_mat_unc.csv")
# H_L_16_mat<-read.csv("~/Desktop/fitted161718_H_L_16_mat_unc.csv")
# H_L_17_mat<-read.csv("~/Desktop/fitted161718_H_L_17_mat_unc.csv")
# H_L_18_mat<-read.csv("~/Desktop/fitted161718_H_L_18_mat_unc.csv")
# S_L_16_mat<-read.csv("~/Desktop/fitted161718_S_L_16_mat_unc.csv")
# S_L_17_mat<-read.csv("~/Desktop/fitted161718_S_L_17_mat_unc.csv")
# S_L_18_mat<-read.csv("~/Desktop/fitted161718_S_L_18_mat_unc.csv")
# 
# 
# B_N_16_mat<-read.csv("~/Desktop/fitted161718_B_N_16_mat_unc.csv")
# B_N_17_mat<-read.csv("~/Desktop/fitted161718_B_N_17_mat_unc.csv")
# B_N_18_mat<-read.csv("~/Desktop/fitted161718_B_N_18_mat_unc.csv")
# H_N_16_mat<-read.csv("~/Desktop/fitted161718_H_N_16_mat_unc.csv")
# H_N_17_mat<-read.csv("~/Desktop/fitted161718_H_N_17_mat_unc.csv")
# H_N_18_mat<-read.csv("~/Desktop/fitted161718_H_N_18_mat_unc.csv")
# S_N_16_mat<-read.csv("~/Desktop/fitted161718_S_N_16_mat_unc.csv")
# S_N_17_mat<-read.csv("~/Desktop/fitted161718_S_N_17_mat_unc.csv")
# S_N_18_mat<-read.csv("~/Desktop/fitted161718_S_N_18_mat_unc.csv")
# 
# 
# 
...
BLAN_16L_data_from_prior<-matrix(0,nrow=nrow(BLAN_a_2016), ncol = 100)
BLAN_16N_data_from_prior<-matrix(0,nrow=nrow(BLAN_a_2016), ncol = 100)
BLAN_17L_data_from_prior<-matrix(0,nrow=nrow(BLAN_a_2017), ncol = 100)
BLAN_17N_data_from_prior<-matrix(0,nrow=nrow(BLAN_a_2017), ncol = 100)
BLAN_18L_data_from_prior<-matrix(0,nrow=nrow(BLAN_a_2018), ncol = 100)
BLAN_18N_data_from_prior<-matrix(0,nrow=nrow(BLAN_a_2018), ncol = 100)
BLAN_19L_data_from_prior<-matrix(0,nrow=nrow(BLAN_a_2019), ncol = 100)
BLAN_19N_data_from_prior<-matrix(0,nrow=nrow(BLAN_a_2019), ncol = 100)




HARV_17L_data_from_prior<-matrix(0,nrow=nrow(HARV_a_2017), ncol = 100)
HARV_17N_data_from_prior<-matrix(0,nrow=nrow(HARV_a_2017), ncol = 100)
HARV_18L_data_from_prior<-matrix(0,nrow=nrow(HARV_a_2018), ncol = 100)
HARV_18N_data_from_prior<-matrix(0,nrow=nrow(HARV_a_2018), ncol = 100)
HARV_21L_data_from_prior<-matrix(0,nrow=nrow(HARV_a_2021), ncol = 100)
HARV_21N_data_from_prior<-matrix(0,nrow=nrow(HARV_a_2021), ncol = 100)
HARV_23L_data_from_prior<-matrix(0,nrow=nrow(HARV_a_2023), ncol = 100)
HARV_23N_data_from_prior<-matrix(0,nrow=nrow(HARV_a_2023), ncol = 100)


SCBI_16L_data_from_prior<-matrix(0,nrow=nrow(SCBI_a_2016), ncol = 100)
SCBI_16N_data_from_prior<-matrix(0,nrow=nrow(SCBI_a_2016), ncol = 100)
SCBI_17L_data_from_prior<-matrix(0,nrow=nrow(SCBI_a_2017), ncol = 100)
SCBI_17N_data_from_prior<-matrix(0,nrow=nrow(SCBI_a_2017), ncol = 100)
SCBI_18L_data_from_prior<-matrix(0,nrow=nrow(SCBI_a_2018), ncol = 100)
SCBI_18N_data_from_prior<-matrix(0,nrow=nrow(SCBI_a_2018), ncol = 100)
SCBI_19L_data_from_prior<-matrix(0,nrow=nrow(SCBI_a_2019), ncol = 100)
SCBI_19N_data_from_prior<-matrix(0,nrow=nrow(SCBI_a_2019), ncol = 100)
SCBI_23L_data_from_prior<-matrix(0,nrow=nrow(SCBI_a_2023), ncol = 100)
SCBI_23N_data_from_prior<-matrix(0,nrow=nrow(SCBI_a_2023), ncol = 100)
...
for (pred_idx in 1:100)
{
  ...
  BLAN_16L_data_from_prior[,pred_idx]<-save_sort_current_B_L_2016
  BLAN_17L_data_from_prior[,pred_idx]<-save_sort_current_B_L_2017
  BLAN_18L_data_from_prior[,pred_idx]<-save_sort_current_B_L_2018
  BLAN_19L_data_from_prior[,pred_idx]<-save_sort_current_B_L_2019
  
  
  BLAN_16N_data_from_prior[,pred_idx]<-save_sort_current_B_N_2016
  BLAN_17N_data_from_prior[,pred_idx]<-save_sort_current_B_N_2017
  BLAN_18N_data_from_prior[,pred_idx]<-save_sort_current_B_N_2018
  BLAN_19N_data_from_prior[,pred_idx]<-save_sort_current_B_N_2019
  
  
  HARV_17L_data_from_prior[,pred_idx]<-save_sort_current_H_L_2017
  HARV_18L_data_from_prior[,pred_idx]<-save_sort_current_H_L_2018
  HARV_21L_data_from_prior[,pred_idx]<-save_sort_current_H_L_2021
  HARV_23L_data_from_prior[,pred_idx]<-save_sort_current_H_L_2023
  
  
  
  HARV_17N_data_from_prior[,pred_idx]<-save_sort_current_H_N_2017
  HARV_18N_data_from_prior[,pred_idx]<-save_sort_current_H_N_2018
  HARV_21N_data_from_prior[,pred_idx]<-save_sort_current_H_N_2021
  HARV_23N_data_from_prior[,pred_idx]<-save_sort_current_H_N_2023
  
  
  SCBI_16L_data_from_prior[,pred_idx]<-save_sort_current_S_L_2016
  SCBI_17L_data_from_prior[,pred_idx]<-save_sort_current_S_L_2017
  SCBI_18L_data_from_prior[,pred_idx]<-save_sort_current_S_L_2018
  SCBI_19L_data_from_prior[,pred_idx]<-save_sort_current_S_L_2019
  SCBI_23L_data_from_prior[,pred_idx]<-save_sort_current_S_L_2023
  
  
  SCBI_16N_data_from_prior[,pred_idx]<-save_sort_current_S_N_2016
  SCBI_17N_data_from_prior[,pred_idx]<-save_sort_current_S_N_2017
  SCBI_18N_data_from_prior[,pred_idx]<-save_sort_current_S_N_2018
  SCBI_19N_data_from_prior[,pred_idx]<-save_sort_current_S_N_2019
  SCBI_23N_data_from_prior[,pred_idx]<-save_sort_current_S_N_2023
...
##write out estimates
write.csv(BLAN_16L_data_from_prior,"~/Desktop/CH2_FEB26/annual_prior_preds_BLAN_L_16_nosamplewindow.csv")
write.csv(BLAN_17L_data_from_prior,"~/Desktop/CH2_FEB26/annual_prior_preds_BLAN_L_17_nosamplewindow.csv")
write.csv(BLAN_18L_data_from_prior,"~/Desktop/CH2_FEB26/annual_prior_preds_BLAN_L_18_nosamplewindow.csv")
write.csv(BLAN_19L_data_from_prior,"~/Desktop/CH2_FEB26/annual_prior_preds_BLAN_L_19_nosamplewindow.csv")

write.csv(BLAN_16N_data_from_prior,"~/Desktop/CH2_FEB26/annual_prior_preds_BLAN_N_16_nosamplewindow.csv")
write.csv(BLAN_17N_data_from_prior,"~/Desktop/CH2_FEB26/annual_prior_preds_BLAN_N_17_nosamplewindow.csv")
write.csv(BLAN_18N_data_from_prior,"~/Desktop/CH2_FEB26/annual_prior_preds_BLAN_N_18_nosamplewindow.csv")
write.csv(BLAN_19N_data_from_prior,"~/Desktop/CH2_FEB26/annual_prior_preds_BLAN_N_19_nosamplewindow.csv")


write.csv(HARV_17L_data_from_prior,"~/Desktop/CH2_FEB26/annual_prior_preds_HARV_L_17_nosamplewindow.csv")
write.csv(HARV_18L_data_from_prior,"~/Desktop/CH2_FEB26/annual_prior_preds_HARV_L_18_nosamplewindow.csv")
write.csv(HARV_21L_data_from_prior,"~/Desktop/CH2_FEB26/annual_prior_preds_HARV_L_21_nosamplewindow.csv")
write.csv(HARV_23L_data_from_prior,"~/Desktop/CH2_FEB26/annual_prior_preds_HARV_L_23_nosamplewindow.csv")


write.csv(HARV_17N_data_from_prior,"~/Desktop/CH2_FEB26/annual_prior_preds_HARV_N_17_nosamplewindow.csv")
write.csv(HARV_18N_data_from_prior,"~/Desktop/CH2_FEB26/annual_prior_preds_HARV_N_18_nosamplewindow.csv")
write.csv(HARV_21N_data_from_prior,"~/Desktop/CH2_FEB26/annual_prior_preds_HARV_N_21_nosamplewindow.csv")
write.csv(HARV_23N_data_from_prior,"~/Desktop/CH2_FEB26/annual_prior_preds_HARV_N_23_nosamplewindow.csv")

write.csv(SCBI_16L_data_from_prior,"~/Desktop/CH2_FEB26/annual_prior_preds_SCBI_L_16_nosamplewindow.csv")
write.csv(SCBI_17L_data_from_prior,"~/Desktop/CH2_FEB26/annual_prior_preds_SCBI_L_17_nosamplewindow.csv")
write.csv(SCBI_18L_data_from_prior,"~/Desktop/CH2_FEB26/annual_prior_preds_SCBI_L_18_nosamplewindow.csv")
write.csv(SCBI_19L_data_from_prior,"~/Desktop/CH2_FEB26/annual_prior_preds_SCBI_L_19_nosamplewindow.csv")
write.csv(SCBI_23L_data_from_prior,"~/Desktop/CH2_FEB26/annual_prior_preds_SCBI_L_23_nosamplewindow.csv")



write.csv(SCBI_16N_data_from_prior,"~/Desktop/CH2_FEB26/annual_prior_preds_SCBI_N_16_nosamplewindow.csv")
write.csv(SCBI_17N_data_from_prior,"~/Desktop/CH2_FEB26/annual_prior_preds_SCBI_N_17_nosamplewindow.csv")
write.csv(SCBI_18N_data_from_prior,"~/Desktop/CH2_FEB26/annual_prior_preds_SCBI_N_18_nosamplewindow.csv")
write.csv(SCBI_19N_data_from_prior,"~/Desktop/CH2_FEB26/annual_prior_preds_SCBI_N_19_nosamplewindow.csv")
write.csv(SCBI_23N_data_from_prior,"~/Desktop/CH2_FEB26/annual_prior_preds_SCBI_N_23_nosamplewindow.csv")
